...
CurrentFile="P:\\D-Permanent\\Dropbox\\5-Permanent\\Astronomy\\Logs\\Ephem\\currentephem.txt"
...
#WINJUPOS
#
Cmsys=(Pattern("1371149953722.png").targetOffset(-382,-3))

#Alt=("Mmmenemeraae.png")
Eph=("1371149972097.png")
...
#ALT
#hover(Alt)
dragDrop("1371149953722.png",Pattern("1371149953722.png").targetOffset(242,27))
type("c", KEY_CTRL)
