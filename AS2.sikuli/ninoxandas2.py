...
# NINOX OPTIONS
#
	MAPNinox=("/Astronomy/5-Permanent/Software/ninox/ninox -qtrim -qestimator -qrenumber -resample=" + str(NinoxScale) + "/1 -outdir=/Astronomy/Sorted/2-Scratch/" + DATE.rstrip('\r\n') + "/" + TIME.rstrip('\r\n') + " /Astronomy/Transit/1-Corianders/" + DATE.rstrip('\r\n') + "/" + TIME.rstrip('\r\n'))
