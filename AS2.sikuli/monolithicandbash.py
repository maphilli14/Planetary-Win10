...
for TIME in TIMEFILE:
	...
	ScratchDirIR = os.path.join(r'/Astronomy/Sorted/2-Scratch/', DATE.rstrip('\r\n'), TIME.rstrip('\r\n'), 'IRtop2000')
	ScratchDirUV = os.path.join(r'/Astronomy/Sorted/2-Scratch/', DATE.rstrip('\r\n'), TIME.rstrip('\r\n'), 'UVtop2000')
	ScratchDirL = os.path.join(r'/Astronomy/Sorted/2-Scratch/', DATE.rstrip('\r\n'), TIME.rstrip('\r\n'), 'Ltop2000')
...
#
	os.system("/home/miphilli/Dropbox/5-Permanent/BASH/Astronomy/Planetary/v9/Ntop2kmoveall.sh " + DATE.rstrip('\r\n') + " " + TIME.rstrip('\r\n') + " " + str(Dcalc))
#
#
# Run AS2
#
