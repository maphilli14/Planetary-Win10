...
def GIMPRGB(STACKEDFOLDER,RGB):
    try:
        ...
        type('o')
        sleep(0.2)
        click(Pattern("1516830319137.png").similar(0.66).targetOffset(38,-38))
        sleep(0.2)
        ...
        if exists("1516832477260.png",2):
            ...
            pass
        sleep(2)
        wait(Pattern("1516833090528.png").targetOffset(-5,15),2)
        click(Pattern("1516833090528.png").targetOffset(-5,15),2)
        sleep(1)
        waitVanish(Pattern("1516833090528.png").targetOffset(-5,15),3)
        sleep(1)
